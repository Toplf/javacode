...
class TeacherTest0077 {

    public static void main(String[] args) {
        Teacher007 t = new Teacher007("佟刚", 40, "男");
...
class TeacherTest0076 {
    ...
    public static void test2(Teacher007 tt) { // 对象的传递, 本质上是传递的地址..
        //tt = new Teacher();
...
class TeacherTest0075 {

    public static void main(String[] args) {
        Teacher007 t1 = new Teacher007(); // 调用简单
        System.out.println(t1.say()); // 谁调用方法 , 谁就是this

        Teacher007 t2 = new Teacher007("明哥", 30, "男"); // 一步到位
        System.out.println(t2.say());
    }
}

class TeacherTest0074 {

    public static void main(String[] args) {
        Teacher007 t1 = new Teacher007(); // 在创建对象时会调用到类的无参构造器
        System.out.println(t1.say());

        //Teacher t2 = new Teacher("佟刚", 40); // 有参构造
        //System.out.println(t2.say());

        Teacher007 t3 = new Teacher007("李明", 30, "男");
